...
Note that, it's hosted on render under a free plan. So, there's a sever limitation of 512 MB RAM, which is just not enough to run `easyOCR` and `YOLO` models. so, the image translation doesn't work on the website. 
